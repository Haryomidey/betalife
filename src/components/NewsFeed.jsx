...
const NewsFeed = () => {
  return (
    <div className='w-full min-h-[60vh] py-16 px-3 laptop:px-20 bg-[#F1F5FE]'>
        <h1 className='about_us font-bold mb-3 tablet:w-[200px] laptop:w-[280px] tablet:text-4xl text-xl mobile:text-2xl pr-3 pb-6 tablet:mx-36 laptop:mx-0'>Newsfeed</h1>
        <p className='pt-16 pb-5 tablet:mx-36 laptop:mx-0'>Featured</p>
